				...
				<div id='profile-wrapper'>
					...
					<div id='profile-form'>
						<div id='profile-headline'>
							<div class='headline-text'>Create a new account</div>
						</div>
						...
						<div id='profile-password'>
							<div class='profile-label'>Create your password</div>
							<input type='password' class='profile-textinput' id='profile-password-input'>
						</div>
						<div id='profile-password-confirm'>
							<div class='profile-label'>Confirm your password</div>
							<input type='password' class='profile-textinput' id='profile-password-input-confirm'>
						</div>
